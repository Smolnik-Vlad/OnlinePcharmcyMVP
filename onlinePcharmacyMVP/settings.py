"""
Django settings for onlinePcharmacyMVP project.
...
SECRET_KEY = 'django-insecure-ffhmdm2%ezur%39hq+(rcdonp$hgit(cc9%12m2j+d81nhs(#m'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=600),  # Время жизни access-токена
...
ROOT_URLCONF = 'onlinePcharmacyMVP.urls'
...
WSGI_APPLICATION = 'onlinePcharmacyMVP.wsgi.application'
